package model;
//classe model, que vai servir de modelo para a aplicacao e o crud
...
public class c_usuarios {
    ...
    //declaracao de um construtor sem parametros | setando valores vazios e zeros aos atributos
    public c_usuarios() {
        this.idUsuario = "";
        this.senhaAcesso = "";
    ...
    //declaracao de um construtor com parametros, atribui seus valores aos repectivos atributos
    ...
    //conjuntos de metodos agrupados aos pares e vinculados a cada atributo
    //responsaveis por setar e recuperar os valores.
